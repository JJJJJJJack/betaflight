...
***********************************************/
#define FLIP_DISABLE_ROLLYAW_TIME 0.8f
#define FLIP_TIME_FORWARD 0.6f                 
#define THETA_DOT_MAX_FORWARD 14.0f
#define THRUST_REVERSE_TIME_FORWARD 0.3f
#define ANGLE_RECOVER_TIME_FORWARD 0.5f
#define THROTTLE_BOOST_TIME_FORWARD 0.3f
